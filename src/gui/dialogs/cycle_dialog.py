...
class CycleDialog(BaseDialog):
    ...
    def __init__(self, parent=None, mode="start", current_cycle=None):
        ...
        super().__init__(parent, title=title, width=450, height=450)
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.species_combo.addItems(["قزل‌آلا", "کپور", "تیلاپیا", "ماهیان خاویاری", "سفید", "کفال", "سایر"])
